...
namespace Shopping.Data
{
    public class SeedDb
    {
        ...
        { 
            ...
            await CheckCategoriesAsync();   //Verifica si no hay categoria en la BD genera 
            await CheckCountriesAsync();
            await CheckRolesAsync();
            await CheckProductsAsync();
            await CheckUserAsync("1010", "Levi", "Zuluaga", "Lakerman@yopmail.com", "322 311 4620", "Calle Luna Calle Sol", "Levi.png", UserType.Admin);
            await CheckUserAsync("2020", "Mikasa", "Bedoya", "Akerman@yopmail.com", "322 311 4620", "Calle Luna noche", "mikasa.png", UserType.User);
            await CheckUserAsync("3030", "Roman", "Riquelme", "romanr@yopmail.com", "322 311 4620", "Calle Luna Calle Sol", "romanr.png", UserType.User);
            await CheckUserAsync("4040", "Angelina", "Jolie", "angelina@yopmail.com", "322 311 4620", "Calle Luna Calle Sol", "Angelina.png", UserType.User);
        ...
        private async Task AddProductAsync(string name, decimal price, float stock, List<string> categories, List<string> images)
        {
            ...
            {
                prodcut.ProductCategories.Add(new ProductCategory { Category = await
        ...
        UserType userType)
        {
            ...
            if (user == null)
            {
                Guid imageId = await _blobHelper.UploadBlobAsync(
        ...
        {
            if (!_context.Categories.Any()) //si en el contexto hay almenos 1 registro
            {
